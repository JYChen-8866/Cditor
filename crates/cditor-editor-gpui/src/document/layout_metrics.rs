...
pub const DEFAULT_DOCUMENT_TOP_INSET_PX: f32 = 0.0;
...
impl DocumentLayoutMetrics {
    ...
    pub const fn with_top_inset_px(mut self, top_inset_px: f32) -> Self {
        self.top_inset_px = top_inset_px;
        self
    }
...
mod tests {
    ...
    fn default_document_layout_is_a_stable_frameless_content_column() {
        ...
        assert_eq!(metrics.top_inset_px, 0.0);

        let with_notice = metrics.with_top_inset_px(32.0);
        assert_eq!(with_notice.top_inset_px, 32.0);
    }
