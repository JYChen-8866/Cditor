...
use crate::command::{CditorCommand, CommandOutcome, CommandState};
use crate::diagnostics::CditorDiagnostics;
use crate::document::{
    CloseGuard, DocumentInfo, DocumentSelection, SaveReport, SaveStatus, ScrollAlignment,
};
use crate::error::CditorError;

/// The small UI contract required by the public component handle.
///
/// The concrete GPUI view remains in `cditor-editor`; the API crate only owns
...
use crate::{Cditor, CditorComponent};
