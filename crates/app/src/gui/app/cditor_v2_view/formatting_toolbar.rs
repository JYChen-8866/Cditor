...
use super::{CditorV2View, formatting_color::selected_spans_color};
...
fn inline_mark_for_toolbar_action(action: InlineFormatAction) -> InlineMark {
    match action {
...
#[cfg(test)]
#[path = "formatting_toolbar_capability_tests.rs"]
