...
#[derive(Debug, Clone, Copy, PartialEq)]
/// Scroll-stability geometry for the current caret.
///
/// The text focus offset belongs to the editing selection and is intentionally
/// excluded so scroll restoration cannot become a second caret truth.
