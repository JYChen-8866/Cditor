...
pub(crate) fn rich_block_kind_to_db(kind: &RichBlockKind) -> String {
    match kind {
        ...
        RichBlockKind::ColumnsGroup => "columns_group".to_owned(),
        RichBlockKind::Column => "column".to_owned(),
...
pub(crate) fn rich_block_kind_from_db(value: &str) -> RichBlockKind {
    ...
    match value {
        ...
        "columns_group" => RichBlockKind::ColumnsGroup,
        "column" => RichBlockKind::Column,
