...
fn builtin_definitions() -> Vec<CommandDefinition> {
    ...
    vec![
        ...
        definition(EDIT_APPLY_MARKDOWN_IMPORT, Args::Markdown, Document),
        ...
        definition(BLOCK_COPY_MARKDOWN, Args::BlockTarget, ReadOnly),
        definition(BLOCK_COPY_LINK, Args::BlockTarget, ReadOnly),
        ...
        definition(TABLE_SET_ALIGN, Args::TableRangeAlign, Document),
