...
pub use block_metrics::{
    ...
    estimate_block_height, estimate_kind_fallback_height, estimate_mermaid_source_block_height_px,
    estimate_rich_spans_height, estimate_text_payload_height, estimate_wrapped_line_count,
    measured_height_tolerance_px, normalize_text_inner_measured_height, text_line_height_for_kind,
    video_block_height_px, video_payload_block_height_px,
};
