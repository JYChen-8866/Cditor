...
pub use backend::{
    ...
    LoadedDocument, LoadedPayloadBatch, StaticStorageProvider, StorageBackendKind,
    StorageCapabilities, StorageDocumentMetadata, StorageProvider, StorageSaveBatch,
