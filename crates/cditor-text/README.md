...
- caret、selection、word/line navigation 和 hit-test geometry。
- inline style、inline box、AccessKit 文本投影。
- 不可变 layout snapshot、surface-aware cache key、reflow 和纯 paint plan。
...
```bash
CDITOR_TRACE_INPUT=1 cargo run -p cditor-app
```
