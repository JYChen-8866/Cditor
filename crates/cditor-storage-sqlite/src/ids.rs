use cditor_core::ids::{AssetId, BlockId, DocumentId};
use uuid::Uuid;
...
const ASSET_ID_NAMESPACE: u128 = 0x3000_0000_0000_0000_0000_0000_0000_0000;
...
pub(crate) fn asset_id_to_sqlite(id: AssetId) -> Uuid {
    Uuid::from_u128(ASSET_ID_NAMESPACE | id as u128)
}
...
pub(crate) fn asset_id_from_sqlite(id: Uuid) -> Option<AssetId> {
    let raw = id.as_u128();
    ((raw & NAMESPACE_MASK) == ASSET_ID_NAMESPACE).then_some((raw & LOW_64_BITS) as u64)
}
