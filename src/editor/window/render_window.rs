...
use crate::core::layout::{BlockHeightIndex, HeightEstimate, PageLayoutIndex};
...
impl RenderWindow {
    ...
    pub fn placeholder(placeholder: PlaceholderWindow) -> Self {
        let local_height_index = BlockHeightIndex::new([HeightEstimate::new(
            placeholder.height,
            crate::core::layout::HeightConfidence::Default,
            0.0,
        )])
...
mod tests {
    use super::*;
    use crate::core::layout::{HeightConfidence, PagePolicy};
