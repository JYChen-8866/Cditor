...
use crate::editor::scroll::VirtualScrollTarget;
use crate::editor::window::{RenderWindow, RenderWindowError};
...
mod tests {
    use super::*;
    use crate::core::layout::{BlockHeightIndex, HeightConfidence, HeightEstimate};
    use crate::editor::scroll::{ScrollPrecision, VirtualScrollTarget};
    ...
    fn delayed_page_load_keeps_stable_window_and_can_show_placeholder() {
        ...
        let placeholder = RenderWindow::placeholder(crate::editor::window::PlaceholderWindow {
            page_range: 50..51,
            block_range: 100..110,
            height: 1_000.0,
            target_anchor: None,
    ...
    fn load_failure_removes_placeholder_and_keeps_current_stable() {
        ...
        coordinator
            .show_placeholder(
                request.generation,
                RenderWindow::placeholder(crate::editor::window::PlaceholderWindow {
                    page_range: 5..6,
                    block_range: 10..12,
                    height: 200.0,
                    target_anchor: None,
