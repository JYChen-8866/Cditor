...
use crate::core::layout::{BlockHeightIndex, HeightConfidence, PageLayoutIndex};
use crate::editor::scroll::virtual_scroll::{
...
mod tests {
    ...
    use crate::core::layout::{BlockHeightIndex, HeightEstimate, PagePolicy};
