...
use crate::core::document::VisibleDocumentIndex;
use crate::core::ids::BlockId;
use crate::core::layout::{BlockHeightIndex, PageLayoutIndex};
use crate::editor::scroll::anchor::{AnchorFrame, AnchorGlobalOffsetResolver, AnchorKind};
use crate::editor::scroll::virtual_scroll::{LayoutPx, ScrollOrigin, VirtualScrollState};
...
mod tests {
    ...
    use crate::core::layout::{HeightConfidence, HeightEstimate, PagePolicy};
    use crate::editor::scroll::{AnchorCandidate, AnchorKind, ScrollAnchor};
    use std::collections::HashMap;
