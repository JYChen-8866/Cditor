...
use crate::core::rich_text::{BlockPayload, RichBlockKind, plain_text_from_spans};
...
pub fn estimate_rich_spans_height(
    kind: &RichBlockKind,
    spans: &[crate::core::rich_text::InlineSpan],
    width_px: f64,
) -> HeightEstimate {
...
mod tests {
    use super::*;
    use crate::core::rich_text::{BlockPayload, InlineSpan};
        ...
        let cases = [
            ...
            (
                RichBlockKind::Callout {
                    variant: crate::core::rich_text::CalloutVariant::Warning,
                },
                94.0,
            ),
