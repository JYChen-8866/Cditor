...
use crate::storage::optimistic_persistence::OptimisticPersistenceManager;

use super::error::{PostgresStorageError, PostgresStorageResult};
use super::persistence_queue::{PersistenceQueueRow, PostgresPersistenceQueue};
...
mod tests {
    ...
    use super::*;
    use crate::storage::optimistic_persistence::PersistenceState;
