...
use crate::core::document::{BlockIndexRecord, DocumentIndex};
use crate::core::ids::DocumentId;
use crate::core::layout::BlockLayoutMeta;
use crate::core::rich_text::{kind_tag_for_rich_block_kind, rich_block_kind_from_tag};
use crate::core::version::StructureVersion;
use crate::storage::traits::DocumentIndexStore;
...
impl PostgresDocumentIndexSnapshot {
    ...
    pub fn into_document_index(
        self,
    ) -> Result<DocumentIndex, crate::core::document::DocumentIndexBuildError> {
...
mod tests {
    ...
    use crate::core::rich_text::kind_tag_for_rich_block_kind;
