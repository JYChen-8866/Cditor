...
use crate::core::edit::EditTransaction;
use crate::core::ids::BlockId;

use super::error::PostgresStorageResult;
use super::transaction_store::{EditTransactionVersions, pg_transaction_id_from_runtime};
use super::types::{PgDocumentId, encode_edit_transaction, pg_block_id_from_runtime};
...
fn transaction_kind_to_sync_operation(
    kind: crate::core::edit::EditTransactionKind,
) -> &'static str {
    match kind {
        crate::core::edit::EditTransactionKind::Typing => "typing",
        crate::core::edit::EditTransactionKind::CompositionCommit => "composition_commit",
        crate::core::edit::EditTransactionKind::Paste => "paste",
        crate::core::edit::EditTransactionKind::DragDrop => "drag_drop",
        crate::core::edit::EditTransactionKind::Format => "format",
        crate::core::edit::EditTransactionKind::ExplicitCommand => "explicit_command",
        crate::core::edit::EditTransactionKind::BlockStructureChange => "block_structure_change",
    }
}
