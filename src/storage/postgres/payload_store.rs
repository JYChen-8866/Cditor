...
use crate::core::rich_text::{BlockPayload, BlockPayloadRecord, RichBlockKind};
...
mod tests {
    ...
    use crate::core::rich_text::{
        ImagePayload, InlineMark, InlineSpan, TableCellPayload, TablePayload, TableRowPayload,
        ...
        BlockPayloadRecord {
            ...
            payload: BlockPayload::Table(TablePayload {
                ...
                rows: vec![TableRowPayload {
                    cells: vec![
                        TableCellPayload {
                            spans: vec![InlineSpan::plain("name")],
                        },
                        TableCellPayload {
                            spans: vec![InlineSpan::plain("value")],
                        },
                    ],
                }],
            }),
