...
mod tests {
    ...
    use crate::core::layout::{HeightConfidence, HeightEstimate};
    use crate::core::rich_text::{BlockPayloadRecord, RichBlockKind, kind_tag_for_rich_block_kind};
    use crate::storage::layout_cache::{BlockLayoutRow, CacheSource, LayoutCacheKey};
    use crate::storage::optimistic_persistence::{OptimisticPersistenceManager, PersistenceState};
    ...
    async fn postgres_integration_search_result_can_jump_to_block() {
        ...
        let index_records = stores
            ...
            .unwrap();
        let document_index =
            crate::core::document::DocumentIndex::new(runtime_document_id, index_records, 1)
                .unwrap();
