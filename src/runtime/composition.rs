...
use crate::editor::hit_test::{CaretGeometryCache, HitTestError, Rect};
use crate::editor::scroll::{AnchorCandidate, AnchorKind, CaretAnchor, ScrollAnchor};
use crate::runtime::input_hot_path::{
    IncrementalLayoutRequest, InputHotPathError, LayoutDirtyRange, LayoutDirtyReason,
    PieceTableTextModel,
};
use crate::runtime::{EditingPriority, EditingSession, EditingSessionError};
...
pub enum CompositionError {
    TextOffset(crate::core::edit::TextOffsetError),
...
impl From<crate::core::edit::TextOffsetError> for CompositionError {
    fn from(error: crate::core::edit::TextOffsetError) -> Self {
...
impl CompositionController {
    ...
    pub fn begin_or_update_preview(
        ...
        session.update_composition(crate::runtime::editing_session::CompositionState {
    ...
    pub fn commit(
        ...
        let transaction = EditTransaction::new(
            ...
            tx_id,
            vec![crate::core::edit::EditOperation::InsertText {
                block_id: state.block_id,
                offset: state.range.start.0,
                text: state.preview_text.clone(),
            }],
            vec![crate::core::edit::EditOperation::DeleteText {
                block_id: state.block_id,
...
mod tests {
    use super::*;
    use crate::core::edit::BidiDirection;
    use crate::core::edit::{TextAffinity, TextPosition};
    use crate::editor::hit_test::{VisualLineLayout, VisualRun};
