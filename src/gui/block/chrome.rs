    ...
    pub fn from_snapshot(block: &ViewBlockSnapshot, theme: GuiTheme) -> Self {
        ...
        Self {
            ...
            prefix_width_px: match block.chrome.prefix {
                crate::core::block::BlockPrefixSnapshot::Callout { .. } => CALLOUT_PREFIX_WIDTH_PX,
                crate::core::block::BlockPrefixSnapshot::None => 0.0,
...
mod tests {
    use super::*;
    use crate::core::block::{BlockChromeSnapshot, BlockListInfo, BlockPrefixSnapshot};
    use crate::core::rich_text::{BlockAttrs, BlockPayloadView};
    use crate::runtime::ViewBlockSnapshot;
    ...
    fn gui_chrome_padding_and_min_height_match_core_height_metrics() {
        for kind in [
            ...
            let style = BlockChromeStyle::from_snapshot(&snapshot, GuiTheme::light());
            let metrics =
                crate::core::layout::block_metrics::text_block_chrome_metrics_for_kind(&kind);
