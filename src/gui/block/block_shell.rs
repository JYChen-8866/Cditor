...
pub fn block_shell(
    ...
    let chrome = BlockChromeStyle::from_snapshot(block, theme);
    let gutter_visible = should_show_gutter(
        hovered,
        block.focused,
        block.selected,
        block.pinned,
    ...
    div()
        ...
        .bg(rgb(chrome.outer_background))
                ...
                div()
                    ...
                    .child(
                        div()
                            ...
                            .border_color(rgb(chrome.quote_bar.unwrap_or(chrome.content_border)))
...
pub fn should_show_gutter(
    ...
    hovered || focused || selected || pinned || action_root
}
...
mod tests {
    ...
    #[test]
    fn gutter_visibility_follows_hover_focus_selection_and_pin() {
        assert!(!should_show_gutter(false, false, false, false, false));
        assert!(should_show_gutter(true, false, false, false, false));
        assert!(should_show_gutter(false, true, false, false, false));
        assert!(should_show_gutter(false, false, true, false, false));
        assert!(should_show_gutter(false, false, false, true, false));
        assert!(should_show_gutter(false, false, false, false, true));
    }
