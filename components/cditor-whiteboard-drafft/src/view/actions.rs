            ...
            && clipboard.as_ref().is_some_and(|item| {
                item.entries().iter().any(|entry| {
                    ...
                    let format = match image.format() {
                        gpui::ImageFormat::Png => drafftink_core::shapes::ImageFormat::Png,
                        gpui::ImageFormat::Jpeg => drafftink_core::shapes::ImageFormat::Jpeg,
                        gpui::ImageFormat::Webp => drafftink_core::shapes::ImageFormat::WebP,
                        _ => return false,
                    };
