    ...
    pub(super) fn render_bottom_toolbar(&self, cx: &mut Context<Self>) -> impl IntoElement {
        div()
            ...
            .child(self.bottom_svg_button(
                "bottom-undo",
                "drafft-icon-undo",
                include_bytes!("../../vendor/drafft-ink/crates/drafftink-app/assets/undo.svg"),
                "Undo (Cmd+Z)",
                self.board.can_undo(),
                BottomAction::Undo,
                cx,
            ...
            .child(self.bottom_svg_button(
                "bottom-redo",
                "drafft-icon-redo",
                include_bytes!("../../vendor/drafft-ink/crates/drafftink-app/assets/redo.svg"),
                "Redo (Cmd+Shift+Z)",
                self.board.can_redo(),
                BottomAction::Redo,
                cx,
            ...
            .child(self.bottom_svg_button(
                "bottom-center",
                "drafft-icon-center",
                include_bytes!("../../vendor/drafft-ink/crates/drafftink-app/assets/center.svg"),
            ...
            .child(self.bottom_svg_button(
                "bottom-fit",
                "drafft-icon-fit",
                include_bytes!("../../vendor/drafft-ink/crates/drafftink-app/assets/zoom-fit.svg"),
            ...
            .child(self.bottom_toggle_button(
                ...
                include_bytes!("../../vendor/drafft-ink/crates/drafftink-app/assets/snap-grid.svg"),
            ...
            .child(self.bottom_toggle_button(
                ...
                include_bytes!(
                    "../../vendor/drafft-ink/crates/drafftink-app/assets/snap-shapes.svg"
                ),
            ...
            .child(self.bottom_toggle_button(
                ...
                include_bytes!("../../vendor/drafft-ink/crates/drafftink-app/assets/angle.svg"),
