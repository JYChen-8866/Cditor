...
use drafftink_core::shapes::{Math, SerializableColor, ShapeTrait};
...
const XITS_MATH: &[u8] =
    include_bytes!("../../vendor/drafft-ink/crates/drafftink-render/assets/rex-xits.otf");
const GELPEN_REGULAR: &[u8] =
    include_bytes!("../../vendor/drafft-ink/crates/drafftink-render/assets/GelPen.ttf");
