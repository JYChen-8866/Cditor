...
impl DrafftBoard {
    ...
    pub(crate) fn snap_result(&self) -> Option<crate::snap::SnapResult> {
        self.snap_result
    }
    ...
    pub(crate) fn smart_guides(&self) -> &[crate::snap::SmartGuide] {
        &self.smart_guides
    }
    ...
    pub(super) fn snap_manipulation_point(
        ...
        self.snap_result = Some(crate::snap::SnapResult {
            point,
