...
pub(crate) struct TextPaint {
    pub shape_id: crate::shapes::ShapeId,
...
fn rgba_serialized(color: crate::shapes::SerializableColor, opacity: f64) -> u32 {
...
mod tests {
    use super::*;
    use crate::shapes::{Rectangle, Shape, Sloppiness};
